...
def ps(x):
	return {
		...
		,'LI.movies.match.items': 				'class="coverImage" title="(.+?)".+?href="(.+?)".+?data-original="(.+?)".+?<a title=".+?\(([\d]+)\)'
		,'LI.movies.match.items2': 				'class="coverImage" title="(.+?)"\s+href="(.+?)">.+?src="(http://static\d*\.solarmovie\.\D+/images/movies/\d+_\d+x\d+\.jpg)".+?<a\stitle=".+?\(([\d]+)\)'
		,'b2LI.movies.match.items2': 				'class="coverImage" title="(.+?)"\s+href="(.+?)">.+?src="(http://static\d*\.solarmovie\.so/images/movies/\d+_\d+x\d+\.jpg)".+?<a\stitle=".+?\(([\d]+)\)'
		...
		,'LI.tv.match.items': 						'class="coverImage" title="(.+?)".+?href="(.+?)".+?data-original="(.+?)".+?<a title=".+?\(([\d]+)\)'
		,'LI.tv.match.items.old': 				'class="coverImage" title="(.+?)".+?href="(.+?)".+?src="(.+?)".+?<a title=".+?\(([\d]+)\)'
