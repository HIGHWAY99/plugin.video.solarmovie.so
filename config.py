...
def ps(x):
	return {
		...
		,'LI.tv.latest.split1': 					'<h2>Latest TV Episodes</h2>'
		,'LI.tv.latest.split1...': 					'<div class="frontpage" id="newFrontPage">'
		,'LI.tv.latest.split2': 					'<h3>'
		,'LI.tv.popular.all.check': 			'Popular'
		,'LI.tv.popular.all.split1': 			'<h2>Most Popular TV Episodes</h2>'
		,'LI.tv.popular.all.split1...': 			'<div class="frontpage" id="newFrontPage">'
		,'LI.tv.popular.all.split2': 			'<h3>'
		,'LI.tv.popular.new.check': 			'NewPopular'
		,'LI.tv.popular.new.split1': 			'<h2>Most Popular New TV Episodes</h2>'
		,'LI.tv.popular.new.split1...': 			'<div class="frontpage" id="newFrontPage">'
